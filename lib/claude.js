...
/**
 * Өмнөх ээлжид үүссэн бодолтын блокуудыг хасна.
 *
 * Бодолтын блок нь өөрийг нь үүсгэсэн загвартай холбоотой байдаг тул
 * ANTHROPIC_MODEL-ийг сольсны дараа хуучин түүх дэх блокууд асуудал
 * үүсгэж болзошгүй. Мөн бид display-г асаадаггүй учраас эдгээр блок
 * бодит текстгүй, зөвхөн гарын үсэг агуулдаг — хасахад алдагдах
 * мэдээлэл БАЙХГҮЙ.
 *
 * Энэ ээлжийн гогцоон дотор үүссэн блокуудыг хөндөхгүй — тэднийг нэг
 * загварт буцааж өгөх нь зөв.
 */
function stripPriorThinking(messages) {
  return messages.map((m) => {
    if (typeof m.content === "string") return m;
...
export async function runAgent({
  ...
  // Ирсэн түүхийг нэг удаа цэвэрлэнэ. Гогцоон дотор нэмэгдэх блокуудыг
  // хөндөхгүй — тэднийг ижил загварт буцааж өгөх нь зөв.
  const msgs = stripPriorThinking(messages);
  const texts = [];
  let stopReason = null;
    ...
    const response = await createMessage(
      {
        ...
        system: systemBlocks,
        ...(tools?.length ? { tools } : {}), // хэрэгсэлгүй дуудлага ч байдаг
