...
### Мэдэхгүй асуултын хариу буцаж очдог

Бот мэдэхгүй асуулт ирэхэд Telegram руу мэдэгдэнэ. Эзэн хариуг нь бичихэд
**асуусан хүн рүү Messenger-ээр автоматаар буцаж очно** — хариуг нь бот
өөрөө боловсон мессеж болгож найруулна.

Гэхдээ Facebook мессеж илгээх хугацааг хатуу хязгаарладаг:

| Хэрэглэгч сүүлд бичсэнээс хойш | Илгээх боломж |
|---|---|
| 24 цагийн дотор | ✅ Чөлөөтэй |
| 24 цаг – 7 хоног | ✅ `HUMAN_AGENT` шошготойгоор |
| 7 хоногоос хойш | ❌ Боломжгүй — утсаар холбогдоно |

Код нь эдгээрийг өөрөө ялгаж, шаардлагатай үед шошго нэмнэ. Илгээж
чадаагүй бол админ AI Telegram дээр шалтгааныг хэлж, утсаар холбогдохыг
сануулна.

`HUMAN_AGENT` шошго ажиллахын тулд App Review дээр **Human Agent**
эрхийг мөн авах шаардлагатай. Аваагүй бол 24 цагийн дараах хариу
илгээгдэхгүй — 24 цагийн доторх нь хэвийн ажиллана.
