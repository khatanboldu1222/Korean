...
Анхдагчаар **Claude Opus 5** (хамгийн ухаалаг) ажиллана.

| Загвар | Оролт / Гаралт (1сая токен) | Нэг ярианы ойролцоо өртөг* |
|---|---|---|
| `claude-opus-5` (анхдагч) | $5 / $25 | ~$0.15 |
| `claude-sonnet-5` | $2 / $10 | ~$0.06 |
| `claude-haiku-4-5` | $1 / $5 | ~$0.03 |

\* 15 мессежийн яриа, prompt caching идэвхтэй үед. Энэ бол **бүдүүвч
тооцоо** — жинхэнэ зардал ярианы урт, мэдээллийн сангийн хэмжээнээс шалтгаална.

Солих бол Vercel дээрх `ANTHROPIC_MODEL` хувьсагчийг өөрчлөөд redeploy
хийхэд л хангалттай — код өөрчлөх шаардлагагүй. Эхлээд Opus 5-аар туршаад,
чанар хангалттай байвал Sonnet 5 рүү буулгаж зардлаа хэмнэх нь бодитой сонголт.

Prompt caching автоматаар идэвхтэй: мэдээллийн сан + дүрмийг кэшлэдэг тул
дараагийн мессеж бүрт тэр хэсэг ~10 дахин хямд болно.
